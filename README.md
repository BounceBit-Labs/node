...
```
cd existing_repo
git remote add origin http://gitlab.blockvision.org/backend/bouncebit/testnet.git
git branch -M main
...
- [ ] [Set up project integrations](http://gitlab.blockvision.org/backend/bouncebit/testnet/-/settings/integrations)
...
>>>>>>> 2dcc2aea970da2d4a1cdf9c1ab1a6a4d47bcb573
